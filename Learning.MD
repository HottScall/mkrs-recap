...
Defining a bike method which returns a bike is actually unneccessary. You can simply remove the bike method and it's contents and replace it with an attr_reader. See line 5.
